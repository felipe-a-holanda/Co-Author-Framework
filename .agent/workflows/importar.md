---
description: Importa um roteiro existente para a estrutura do framework, populando o atlas e separando as cenas
---

# /importar

**Uso:** `/importar <arquivo> <nome-do-projeto>`
...
- O documento original **não é apagado** — copiar para `rascunhos/` antes de qualquer processamento
